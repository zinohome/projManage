...
class ChangerequestAdmin(SwiftAdmin):
    ...
    async def get_create_action(self, request: Request, bulk: bool = False) -> Optional[Action]:
        try:
            ...
            print('Exception at ChangerequestAdmin.get_create_action() %s ' % exp)
            traceback.print_exc()
    ...
    async def get_read_action(self, request: Request) -> Optional[Action]:
        try:
            ...
            print('Exception at ChangerequestAdmin.get_read_action() %s ' % exp)
            traceback.print_exc()
    ...
    async def get_update_action(self, request: Request, bulk: bool = False) -> Optional[Action]:
        try:
            ...
            print('Exception at ChangerequestAdmin.get_update_action() %s ' % exp)
            traceback.print_exc()
    ...
    async def get_print_action(self, request: Request) -> Optional[Action]:
        try:
            ...
            print('Exception at ChangerequestAdmin.get_print_action() %s ' % exp)
            traceback.print_exc()
    ...
    async def get_print_form(self, request: Request) -> Form:
        try:
            ...
            print('Exception at ChangerequestAdmin.get_print_form() %s ' % exp)
            traceback.print_exc()
    ...
    async def get_read_form(self, request: Request) -> Form:
        try:
            ...
            print('Exception at ChangerequestAdmin.get_read_form() %s ' % exp)
            traceback.print_exc()
    ...
    async def get_create_form(self, request: Request, bulk: bool = False) -> Form:
        try:
            ...
            print('Exception at ChangerequestAdmin.get_create_form() %s ' % exp)
            traceback.print_exc()
    ...
    async def get_update_form(self, request: Request, bulk: bool = False) -> Form:
        try:
            ...
            print('Exception at ChangerequestAdmin.get_update_form() %s ' % exp)
            traceback.print_exc()
    ...
    async def get_duplicate_form_inner(self, request: Request, bulk: bool = False) -> Form:
        try:
            ...
            print('Exception at ChangerequestAdmin.get_duplicate_form_inner() %s ' % exp)
            traceback.print_exc()
    ...
    async def get_duplicate_action(self, request: Request, bulk: bool = False) -> Optional[Action]:
        try:
            ...
            print('Exception at ChangerequestAdmin.get_duplicate_action() %s ' % exp)
            traceback.print_exc()
    ...
    async def get_review_form(self, request: Request, bulk: bool = False) -> Form:
        try:
            ...
            print('Exception at ChangerequestAdmin.get_review_form() %s ' % exp)
            traceback.print_exc()
    ...
    async def get_review_action(self, request: Request, bulk: bool = False) -> Optional[Action]:
        try:
            ...
            print('Exception at ChangerequestAdmin.get_review_action() %s ' % exp)
            traceback.print_exc()
    ...
    async def on_update_pre(
        ...
        try:
            ...
            print('Exception at ChangerequestAdmin.on_update_pre() %s ' % exp)
            traceback.print_exc()
    ...
    def route_create(self) -> Callable:
        async def route(
            ...
            try:
                ...
                print('Exception at ChangerequestAdmin.route_create() %s ' % exp)
                traceback.print_exc()
    ...
    def route_update(self) -> Callable:
        async def route(
            ...
            try:
                ...
                print('Exception at ChangerequestAdmin.route_update() %s ' % exp)
                traceback.print_exc()
